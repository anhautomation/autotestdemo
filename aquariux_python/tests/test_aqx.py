...
def test_flow_E2E(page):
    ...
    aquariux.click_open_position
    aquariux.click_notification()
    aquariux.refresh_page()
    aquariux.select_buy_option()
    aquariux.select_order_type("Limit")
    aquariux.input_size("0.2")
    aquariux.input_price("1.5")
    aquariux.input_stop_loss_points("50")
    aquariux.input_take_profit_points("50")
    aquariux.click_place_buy_order()
    aquariux.click_trade_confirm()
    aquariux.click_pending_order()
    aquariux.click_notification()
